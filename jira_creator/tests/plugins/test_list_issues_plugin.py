...
class TestListIssuesPlugin:
    ...
    def test_register_arguments(self):
        ...
        expected_calls = [
            (("-p", "--project"), {"help": "Project key (uses JIRA_PROJECT_KEY env if not specified)", "default": None}),
            ...
            (("-m", "--max-results"), {"type": int, "default": 100, "help": "Maximum number of results (default: 100)"}),
        ]
    ...
    def test_rest_operation(self, mock_env_fetcher):
        ...
        mock_client.request.assert_called_once_with(
            "GET", "/rest/api/2/search", params=expected_params
        )
    ...
    def test_execute_with_multiple_issues(self, mock_massage, mock_format_print, mock_env_fetcher):
        ...
        mock_massage.return_value = (["key", "summary"], [("TEST-1", "Issue 1"), ("TEST-2", "Issue 2"), ("TEST-3", "Issue 3")])
