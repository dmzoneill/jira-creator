...
class TestQuarterlyConnectionPlugin:
    ...
    def test_rest_operation_successful(self):
    ...
    def test_rest_operation_with_missing_issue_fields(self):
    ...
    def test_issue_type_and_status_counting(self):
    ...
    def test_case_insensitive_cve_filtering(self):
