...
class PromptLibrary:
    ...
    _PROMPTS = {
        IssueType.DEFAULT: """As a professional Principal Software Engineer, you write acute and clear summaries and descriptions for JIRA issues.
You focus on clarity and completeness.""",
        
        IssueType.COMMENT: """As a professional Principal Software Engineer, you write great comments that are clear and helpful.
You focus on providing context and clarity.""",
...
You focus on high-level goals and value.""",
        ...
        IssueType.QC: """You are a software engineering manager with expertise in quarterly planning and connection tracking.
You focus on strategic alignment and measurable outcomes.""",
        
        IssueType.AIHELPER: """You are an intelligent assistant that converts natural language requests into well-structured JIRA issues.
You focus on clarity and completeness.""",
    }
