...
class TestEditIssuePlugin:
    ...
    def test_rest_operation(self):
        ...
        mock_client.request.assert_called_once_with(
            "PUT", "/rest/api/2/issue/TEST-123", json_data=expected_payload
        )
    ...
    def test_fetch_description_success(self):
        ...
        mock_client.request.assert_called_once_with(
            "GET", "/rest/api/2/issue/TEST-123?fields=description"
        )
    ...
    def test_get_issue_type_success(self):
        ...
        assert result == "BUG"
        mock_client.request.assert_called_once_with(
            "GET", "/rest/api/2/issue/TEST-123?fields=issuetype"
        )
