...
class TestListSprintsPlugin:
    ...
    def test_rest_operation_single_page(self):
        ...
        mock_client.request.assert_called_once_with(
            "GET",
            "/rest/agile/1.0/board/123/sprint?startAt=0&maxResults=50"
        )
    ...
    def test_rest_operation_multiple_pages(self):
        ...
        assert calls[0][0] == ("GET", "/rest/agile/1.0/board/456/sprint?startAt=0&maxResults=50")
        assert calls[1][0] == ("GET", "/rest/agile/1.0/board/456/sprint?startAt=50&maxResults=50")
    ...
    def test_rest_operation_with_missing_isLast(self):
        ...
        mock_client.request.return_value = {
            "values": [
                {"id": 1, "name": "Sprint X", "state": "active"}
            ]
        }
